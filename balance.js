...
router.post('/checkBalance',async(req,res)=>{
   ...
   // var result = await contract.methods.balanceOf(account).call()
    //console.log(result)
    //result='100000000'
   //res.send(`Balance of account: ${web3.utils.fromWei(result, 'ether')}`)
   ...
   { 
    ...
    res.json({amount:Amount})
      // res.json(` ${web3.utils.fromWei(result, 'ether')}`) 
