...
const rpcURL = 'HTTP://127.0.0.1:7545' // Paste the Ganache RPC Url here, e.g. http://localhost:7545
...
const address = '0x9b0bf9898aA73a9769AaD72720608F32b59CE7a2' // Paste the smart contract address here after you have deployed it


const contract = new web3.eth.Contract(abi, address)

//const owner    = '0xD289f40482c3f54EdBA5fc079d69C589c709d1a0' // Paste the 1st account from Ganache here
//const account = '0x66FFcBe53317Da1A9148727cC85661f0C05896C6' // Paste the 2nd account from Ganache here
//const account2 = '0x31AcFB57fCf9D3C23e81b3c2681C85f5228cfE54' // Paste the 3rd account from Ganache here



router.post('/mintTransfer',async(req,res)=>{
  const Owner=req.body.owner
   const Account=req.body.account
   amount=req.body.amount
   amount = web3.utils.toWei(amount)
   await contract.methods.mint(Account, amount).send({ from: Owner })
   const result=web3.utils.fromWei(amount,'ether')
   res.json({msg:`Successfully Minted ${result} Points`})
   //res.json(`Successfully Minted ${web3.utils.fromWei(amount, 'ether')} Points`)
})
